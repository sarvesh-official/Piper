            ...
            <div className="bg-white dark:bg-piper-darkblue rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
                      ...
                      <span>6 hours • 5 modules • Generated by Piper AI</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="h-[400px] overflow-y-auto p-6">
                ...
                <div className="mt-6 flex justify-between items-center">
                  <button className="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white dark:text-piper-darkblue bg-piper-blue dark:bg-piper-cyan dark:hover:bg-piper-cyan/90 hover:bg-piper-blue/90 transition-colors">
