...
export default function UserMetaCard() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Update social links in unsafe metadata while preserving other fields
      await user.update({
        unsafeMetadata: {
          ...existingMetadata,
  ...
  // Function to get social link from metadata
          ...
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
              <Image
                width={80}
                height={80}
                src={`${isLoaded ? user?.imageUrl : "/piper-mascot.svg"}`}
                alt="user"
              />
            </div>
            ...
            <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
              <a
                ...
                onClick={(e) => !getSocialLink("facebook") && e.preventDefault()}
              ...
              <a
                ...
                onClick={(e) => !getSocialLink("twitter") && e.preventDefault()}
                target="_blank"
                rel="noreferrer"
                className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
              >
              ...
              <a
                ...
                onClick={(e) => !getSocialLink("linkedin") && e.preventDefault()}
                target="_blank"
                rel="noreferrer"
                className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
              >
              ...
              <a
                ...
                onClick={(e) => !getSocialLink("instagram") && e.preventDefault()}
                target="_blank"
                rel="noreferrer"
                className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
              >
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          ...
          <form className="flex flex-col" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
              ...
              <Button size="sm" onClick={handleSave} className="bg-piper-blue dark:bg-piper-cyan dark:text-piper-darkblue" disabled={isSubmitting}>
